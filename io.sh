...
function manageMenu () {
	...
	case $MENU_OPTION in
		...
		;;
		6)
			cd /var/www/html/panel && git pull || return
		;;
		7)
...
function setupBanner () {
	...
	BjornVPN Squid Proxy Port: ${squidPORTS[0]}/${squidPORTS[1]}/${squidPORTS[2]}/${squidPORTS[3]}/${squidPORTS[4]}/${squidPORTS[5]}/${squidPORTS[6]}/${squidPORTS[7]}
